...
# Define a function to generate a square wave at a specific frequency
...
# Load your square wave sample (or generate one if you prefer)
sample_rate = 44100
...
note_duration = 250  # in milliseconds
melody = [
    "C4", "E4", "G4", "G4", "E4", "F4", "G4", "G4",
    "C4", "E4", "G4", "G4", "E4", "F4", "G4", "G4",
    "A4", "G4", "F4", "E4", "D4", "C4", "C4", "C4"
]
...
# Export the melody
melody_track.export("mario_melody.wav", format="wav")
